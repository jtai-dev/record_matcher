...
def test_columns_to_get_adding_and_removal_of_y_columns(test_config:MatcherConfig):
    ...
    assert test_config.y_columns.intersection(test_config.columns_to_get) == {'a'}

    test_config.columns_to_get.add('b')
    assert test_config.y_columns.intersection(test_config.columns_to_get) == {'a','b'}

    test_config.columns_to_get.remove('a')
    assert test_config.y_columns.intersection(test_config.columns_to_get) == {'b'}

    test_config.columns_to_get.remove('b')
    assert test_config.y_columns.intersection(test_config.columns_to_get) == set()
